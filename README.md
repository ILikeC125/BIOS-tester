#repository
Yeah so this is just a simple lil "OS" bootloader to test if your computer has BIOS/CSM/Legacy boot capabilities.
How to use:
Step 1: Since this isnt like an MS bootloader, you will need to turn OFF secure boot. BE CAREFUL WITH THIS, if you have had malware on your computer at all, I dont recommend turning off secure boot because malware might boot itelf. Your choice, this ISNT malware.
